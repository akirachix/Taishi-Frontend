...
//     try {
//       const response = await fetchWithTimeout(createTranscription(audioFile, caseName, caseNumber), 300000);
//       alert('Transcription process started successfully.');
//       setUploadStatus(`Upload successful! Transcription ID: ${response.id}`);
//       setShowModal(false);
//     } catch (error) {
...
//                 <button
//                   onClick={handleAddCaseAudio}
//                   className={`bg-yellow-500 text-white px-4 py-2 rounded-md ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
//                   disabled={isSubmitting}
//                 >
//                   {isSubmitting ? 'Transcribing Audio...' : 'Add Audio'}
//                 </button>

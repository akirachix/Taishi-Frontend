...
const JudgeDashboardPage = () => {
  ...
  const cases = [
    { caseNo: 'CASE22465', title: 'Irungu Khushko Khamati', accuracy: '80%', confidence: 'Wesley Odipo', date: '2 August 2023', time: '23:49hrs', status: 'OPEN CASE' },
    { caseNo: 'CASE545', title: 'Idi Amin', accuracy: '80%', confidence: 'John Doe', date: '2 January 2017', time: '13:45hrs', status: 'OPEN CASE' },
    { caseNo: 'CASE546', title: 'Example Case', accuracy: '75%', confidence: 'Jane Smith', date: '15 March 2022', time: '10:30hrs', status: 'CLOSED CASE' },
  ...
  return (
    <div className="bg-white xl:p-16 nh:p-0 flex flex-col">
      <header className="flex justify-between items-center mb-8 nh:mb-0">
        <h1 className="text-2xl nh:text-lg font-bold text-yellow-500">Cases</h1>
      ...
      <main className="flex-grow flex flex-col">
        ...
        <div className="mt-auto">
          <h3 className="text-3xl  nh:text-xl nm:text-[20px] font-semibold  nh:mb-3">Past Transcriptions</h3>
